...
namespace VendorManagementAPI
{
    public class Vendor
    {
        ...
        public string AddVendor(Vendor vendor)
        {
            ...
            else if (vendorList.Any(v => v.VendorPhoneNumber == vendor.VendorPhoneNumber))
            {
                throw new Exception("This phone number already associated with another vendor");
            }
        ...
        public string UpdateVendor(string vCode,Vendor vendor)
        {
            ...
            if (tempVendor != null)
            {
                ...
                else if (vendorList.Any(v => v.VendorPhoneNumber == vendor.VendorPhoneNumber && v.VendorCode != vendor.VendorCode))
                {
                    throw new Exception("This phone number already associated with another vendor");
                }
