...
console.log("------------------------------------------------------------------------");
console.log(library.addBook(new Book_1.Book("DSA", "ABC", "123dsa", 5)));
console.log(library.addBook(new Book_1.Book("Angular", "XYZ", "dsa", 5)));
console.log(library.addBook(new Book_1.Book("The Pragmatic Programmer", "Andrew Hunt and David Thomas", "978-0201616224", 1)));
console.log(library.addBook(new Book_1.Book("Clean Code", "Robert C. Martin", "978-0132350884", 2)));
console.log(library.addBook(new Book_1.Book("Design Patterns: Elements of Reusable Object-Oriented Software", "Erich Gamma, Richard Helm, Ralph Johnson, and John Vlissides", "978-0201633610", 1)));
...
console.log("------------------------------------------------------------------------");
//user operations 
let user = new User_1.User("sdf", "ds");
