...
namespace ShoppingAPI.Controllers
{
    ...
    public class ProductsAPIController : ControllerBase
    {
        ...
        {
            var p = productsRepository.ProductsByCategory(category);
            return Ok(p);
        }
        ...
        [HttpGet("/matchingProducts/{startsWith}")]
        public IActionResult GetProductsMatching(string startsWith)
        {
            var p = productsRepository.GetProductsmatchingName(startsWith);
            return Ok(p);   
        }



        //public ProductsAPIController(ShoppingDb2Context context)
        //{
        //    _context = context;
        //}
